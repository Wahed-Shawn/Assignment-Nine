...
const GreenExperts = () => {
    return (
        <div>
            <h1 className='text-center text-3xl font-semibold'>Meet Our Green Experts</h1>
            <p className='text-center mt-1.5 text-gray-500'>The hearts and hands behind our botanical family.</p>

            <div className="mt-12 grid grid-cols-4 justify-items-center">
