...
const DecorIdeas = () => {
    return (
        <div className='mt-[5rem]'>
            ...
            <div className="md:h-[28rem] flex flex-col gap-8 md:flex-row">
                <div className="h-[28rem]  rounded-3xl overflow-hidden">
                ...
                <div className="h-[28rem] grid grid-cols-12 grid-rows-12 gap-5">
