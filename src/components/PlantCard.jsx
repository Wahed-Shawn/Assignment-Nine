    ...
    return (
        <div className="card shadow-sm border border-gray-300 hover:shadow-2xl hover:shadow-green-500">
            ...
            <div className="card-body">
                ...
                <button className='btn bg-green-300/60 text-lg text-green-600 py-6 hover:bg-green-400 hover:text-white'>View Details</button>
            </div>
        </div>
    );
};
